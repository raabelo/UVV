...
"{"                     { console.log('Token: {');   escopoAtual++; console.log(escopoAtual);      return '{'; }
"}"                     { console.log('Token: }');   escopoAtual--; console.log(escopoAtual);       return '}'; }
...
assignment_expression
  : var_type id '=' value_lit {criarVariavel($1, $2, $4, escopoAtual); }
  // | id value_lit {criarVariavel($1, $2, 0, escopoAtual); }
  | var_type id ';' {criarVariavel($1, $2, 0, escopoAtual); }
  | var_type id '[' value_lit ']' '=' '{' array_stmt '}' {criarVariavel($1, $2, ($7, $8, $9), escopoAtual); }
  | var_type id '[' value_lit ']' ';' {criarVariavel($1, $2, 0, escopoAtual); }
  | value_lit '=' value_lit 
...
id
  : IDF { } /* $1 representa o valor reconhecido de IDF */
  | IDF ',' IDF { } /* $1 representa o valor reconhecido de IDF */
  ;
